...
const selProduct = [
    { productColor: "white", productColorName: "White", productColorNameC: "#000", src: `${Config.ProductImage}/powerbeats-white.png.large.2x.png.large.2x.png`, check: 1 },
    { productColor: "black", productColorName: "Black", productColorNameC: "#fff", src: `${Config.ProductImage}/powerbeats-black.png.large.2x.png.large.2x.png`, check: 1 },
    { productColor: "#911827", productColorName: "Red", productColorNameC: "#fff", src: `${Config.ProductImage}/powerbeats-red.png.large.2x.png.large.2x.png`, check: 1 }
]
            ...
            <div className="ProductDetailPage">
                <section className="headerWrapper">
                    ...
                    <div className="headerImage">
                        ...
                        <img alt="powerbeats" src={`${Config.detailImage}01.jpg.large.2x.jpg`} />
                    </div>
                </section>
                <section className="mainContentsReady">
                    ...
                    <div className="imageAndText">
                        <div className="leftContent">
                            <img alt="skate" src={`${Config.detailImage}02.jpg.large.2x.jpg`} />
                        </div>
                        <div className="rightContent">
                            ...
                            <div className="contentImageRight">
                                <img alt="man" src={`${Config.detailImage}03.jpg.large.2x.jpg`} />
                            </div>
                        </div>
                    </div>
                    <div className="sectionSpacing"></div>
                ...
                <section className="mainContentsBring">
                    <div className="imgWrap">
                        <img alt="walking man" src={`${Config.detailImage}05.jpg.large.2x.jpg`} />
                ...
                <section className="mainContentsPerformance">
                    <div className="imgwrap">
                        <img alt="power beats" src={`${Config.detailImage}04.png.large.2x.png`} />
                    </div>
                    <div className="textWrap">
                        <TextPiece
                            width="60%"
                    ...
                    <div className="imageAndText">
                        <div className="leftContent">
                            ...
                            <div className="contentImageLeft">
                                <img alt="woman" src={`${Config.detailImage}07.jpg.large.2x.jpg`} />
                            </div>
                        </div>
                        <div className="rightContent">
                            <img alt="womanfull" src={`${Config.detailImage}06.jpg.large.2x.jpg`} />
                        </div>
                    </div>
                    <div className="sectionSpacing"></div>
                </section>
                <section className="mainContentsSelect" id="buy" style={{ backgroundColor: selProduct[this.state.current].productColor }}>
                    ...
                    <div className="selectColorWrapper">
                        ...
                        <div className="selectColorCircle">
                            <div onClick={this.changeWhite} className="colorCirclesWhite" >
                                <span className="checkedWhite" style={{ opacity: this.state.check }}/>
                            </div>
                            <div onClick={this.changeBlack} className="colorCirclesBlack">
                                <span className="checkedBlack" style={{ opacity: this.state.check }}/>
                            </div>
                            <div onClick={this.changeRed} className="colorCirclesRed">
                                <span className="checkedRed" style={{ opacity: this.state.check }}/>
                            </div>
                        </div>
                        <div className="selectColorName">
                            <div className="selectProductName" style={{ color : selProduct[this.state.current].productColorNameC }}>{ selProduct[this.state.current].productColorName }</div>
                        </div>
                        <div className="selectColorImgWrap">
                            ...
                            <div className="imageWrap">
                                <div className="productImg1">
                                    <img alt="productWhite" src={ selProduct[this.state.current].src } />
                                </div>
                            </div>
                ...
                <section className="mainContentsListen">
                    <div className="imgWrap">
                        <img alt="walking man" src={`${Config.detailImage}08.jpg.large.2x.jpg`} />
                        <div className="textWrap">
                            <TextPiece  
                                color="#fff"
                    ...
                    <div className="containerWrap">
                        <div className="widthContainer">
                            <div className="detailWrap">
                                <img alt="detail" src={`${Config.ProductDetail}-p11c.jpg.large.2x.jpg`} />
                                <div className="textWrap">
                                    <h4>Enhanced call performance</h4>
                                    <p>With multiple on-ear microphones that target your voice and filter out external noise, and Class 1 Bluetooth for extended range and fewer dropouts.</p>
                                </div>
                            </div>
                            <div className="detailWrap">
                                <img alt="detail" src={`${Config.ProductDetail}-p09a.jpg.large.2x.jpg`} />
                                <div className="textWrap">
                                    <h4>On-ear controls</h4>
                                    <p>Take calls, skip songs, and adjust volume directly from the earbud, so you don’t need your device to control your audio.</p>
                                </div>
                            </div>
                            <div className="detailWrap">
                                <img alt="detail" src={`${Config.ProductDetail}-p10b.jpg.large.2x.jpg`} />
                                <div className="textWrap">
                                    <h4>Voice controls</h4>
                                    <p>Stay in the zone with hands-free controls via “Hey Siri” on iOS devices, and voice capability with the push of the b button on a variety of compatible devices.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="whatInTheBox">
                    <div className="contentWrap">
                        ...
                        <div className="imgWrap">
                            <img alt="box" src={`${Config.ProductDetail}-p12.png.large.2x.png`} />
                        </div>
                    </div>
                </section>
            </div>
