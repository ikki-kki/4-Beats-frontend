                ...
                <Fade bottom>
                  <div className="Tile">
                    <div className="Tile-Inner">
                      ...
                      <p>
                        Find answers to all of your questions about service
                        options, warranty, and pricing in your country.
                      </p>
                      <div className="Btn">
                        <GrayBorderButton
                  ...
                  <div className="Tile">
                    <div className="Tile-Inner">
                      ...
                      <p>
                        Check for software updates or rename your Beats and make
                        it your own.
                      </p>
                      <div className="Btn">
                        <GrayBorderButton
                  ...
                  <div className="Tile">
                    <div className="Tile-Inner">
                      ...
                      <p>
                        ...
                        Retail Store, Apple Online Store or authorized
                        retailers.
                      </p>
                      <div className="Btn">
                        <GrayBorderButton
