        ...
        <React.Fragment>
      {
        ...
        >
          <div className ="SignUn">
              <div className="Modal-signUn-overlay" onClick={this.props.close} />
              <div className="loginForm">
       
                    <div className="Component-SignUp">
                            <button className="gotobackBtn" onClick={this.props.changeCo}><span className="material-icons">navigate_before</span></button>
                            <button className="closeBtn-signUp" onClick={this.props.close}><span className="material-icons">close</span></button>
                            ...
                            <div className="haveAccount"><button className="havaAccountBtn" onClick={this.props.changeCo}>Do you already have an Beats account?</button></div>
                    </div>
                </div>
            </div>
                </ReactTransitionGroup>
